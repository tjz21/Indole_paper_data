...
def main():
    ...
    run_name = "Indole in vacuum"

    energy_1 = 0.1839861155703148
    energy_2 = 0.193174
    coupling = 0.0001512945953744476
    dipole_moment_1 = 0.4843237559038706
    dipole_moment_2 = 0.9927140607490476

    savedir = os.getcwd()
    coeffsdir = os.path.join(savedir, "chain_coeffs.hdf5")

    time_step = 10.0
    total_time_absorption = 10000.0
    total_time_emission = 4200.0
    temp = 300
    chain_length = 150
    num_fock = 30
    bond_dims = [40]
    ...
    # Propagate excited state (to calculate the absorption spectrum)
    ...
    # Prepare initial state for emission calculation
